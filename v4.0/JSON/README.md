...
### Fichier [criteres.json](https://github.com/DISIC/RGAA/releases/download/v4.0/criteres.json "Télécharger le fichier criteres.json (1,38 Mo)")
...
### Fichier [glossaire.json](https://github.com/DISIC/RGAA/releases/download/v4.0/glossaire.json "Télécharger le fichier glossaire.json (681 Ko)")
